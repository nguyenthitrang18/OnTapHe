...
public class BookForm extends javax.swing.JFrame {
    private List<Book1> lstb1;
    private Book1Service service;
    ...
    public BookForm() {
        ...
        service = new Book1Service();
        lstb1 = service.ListSrv();
...
//        JOptionPane.showMessageDialog(this, "Không tìm thấy thông tin");
    ...
    private void btnThemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnThemActionPerformed
        // TODO add your handling code here:
        boolean check = service.insertB(getForm());
        if (check) {
    ...
    private void btnsuaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnsuaActionPerformed
        // TODO add your handling code here:
        boolean check = service.updateB(txtma.getText(),getForm());
        if (check) {
